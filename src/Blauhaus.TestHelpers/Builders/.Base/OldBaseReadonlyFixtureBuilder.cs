...
{
    public abstract class OldBaseReadonlyFixtureBuilder<TBuilder, T>: BaseBuilder<TBuilder, T>
        where TBuilder : OldBaseReadonlyFixtureBuilder<TBuilder, T> 
        where T : class
    {
        private readonly Fixture _fixture;

        protected OldBaseReadonlyFixtureBuilder()
        {
